...
const BOOKING_WEBHOOK_URL=document.body.dataset.webhookUrl||"";
...
async function submitReservation(payload){
  if(!BOOKING_WEBHOOK_URL){
    return {ok:false,message:"No s'ha configurat l'enviament. Afegeix l'URL del webhook (data-webhook-url a l'HTML)."};
  }
  try{
